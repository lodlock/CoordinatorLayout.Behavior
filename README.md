#CoordinatorLayout Snackbar Example
This example is to show how to implement a CoordinatorLayout.Behavior on any view element.

Examples are shown via both app:layout_behavior and a custom class that utilizes the behavior.
